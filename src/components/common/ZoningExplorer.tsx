...
export function ZoningExplorer() {
  ...
  return (
    <section className="zoning-explorer" aria-labelledby="zoning-explorer-title">
      <div className="zoning-tabs-panel">
        ...
        <div className="zone-tab-list" role="tablist" aria-label="Healthcare facility zones">
          {zoningAreas.map((area, index) => (
            <button
              key={area.title}
              id={`zone-tab-${index}`}
              className={`zone-tab ${activeIndex === index ? "active" : ""}`}
              type="button"
              role="tab"
        ...
        <div className="zone-content">
          <figure className="zone-image-frame">
            <img src={active.image} alt={`${active.title} zoning illustration`} />
          </figure>
          <aside
            id="zoning-products"
            className="zone-panel"
            role="tabpanel"
            aria-labelledby={`zone-tab-${activeIndex}`}
          >
